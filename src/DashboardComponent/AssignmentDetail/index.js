...
const AssignmentDetail = () => {
  ...
  useEffect(() => {
    ...
    const fetchAssignmentDetails = async () => {
      ...
      setAssignment(fetchedAssignment); // Change to fetchedAssignment1 or fetchedAssignment2 for testing
    };
  ...
  const handleSubmit = () => {
    // Logic to handle submission of the assignment
    alert("Assignment submitted!");
    navigate("/"); // Navigate back to the home page or another page after submission
  };
